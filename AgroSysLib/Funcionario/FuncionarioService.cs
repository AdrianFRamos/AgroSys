namespace AgroSysLib
{
    public class FuncionarioService
    {
        ...
        public string AutenticarFuncionario(string usuario, string senha)
        {
            ...
            {
                return $"erro: {ex.Message}"; // Retorna "erro" para indicar que houve um erro ao autenticar o funcionário
            }
        }
        ...
        public string AutenticarGerente(string usuario)
        {
            ...
            {
                return $"erro: {ex.Message}"; // Retorna "erro" para indicar que houve um erro ao autenticar o funcionário como gerente
            }
        }
        ...
        public string VerificarUsuarioDisponivel(string usuario)
        {
            ...
            {
                return $"erro: {ex.Message}"; // Retorna "erro" para indicar que houve um erro ao verificar a disponibilidade do usuário
            }
        }
